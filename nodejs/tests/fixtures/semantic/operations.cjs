class SemanticOriginalError extends Error {
  constructor() {
...
function recursiveClosure(value) {
...
function shortCircuitAndException() {
...
async function promiseIsolation(requestId) {
...
async function runSemanticScenario(requestId) {
...
function assertSemanticResult(value, requestId) {
  const expected = {
...
module.exports = { SemanticOriginalError, recursiveClosure, getterAndAssignment, shortCircuitAndException, promiseIsolation, runSemanticScenario, assertSemanticResult };
